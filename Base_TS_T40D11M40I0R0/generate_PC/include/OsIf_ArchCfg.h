...
/* ARM_MIXT - is used to specify the ARM architecture MCAL_MARCH, MCAL_RARCH, MCAL_AARCH32, MCAL_AARCH64 */
 [!SELECT "as:modconf('Resource')[1]"!][!//
                            ...
                            [!ELSEIF "(ResourceGeneral/ARM_CoreArchitecture = 'ARM_A32_ARCH')"!][!//
                                #define MCAL_PLATFORM_ARM  MCAL_ARM_AARCH32
                            [!ELSEIF "(ResourceGeneral/ARM_CoreArchitecture = 'ARM_M_ARCH')"!][!//
                                #define MCAL_PLATFORM_ARM  MCAL_ARM_MARCH
                            [!ELSEIF "(ResourceGeneral/ARM_CoreArchitecture = 'ARM_R_ARCH')"!][!//
