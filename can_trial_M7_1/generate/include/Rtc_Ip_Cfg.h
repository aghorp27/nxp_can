...
*                                     FILE VERSION CHECKS
==================================================================================================*/
#if (RTC_IP_VENDOR_ID_CFG != RTC_IP_VENDOR_ID_BOARD_INITPERIPHERALS_PBCFG_H)
    #error "Rtc_Ip_Cfg.h and Rtc_Ip_BOARD_InitPeripherals_PBcfg.h have different vendor ids"
#endif
/* Check if this header file and header file are of the same Autosar version */
#if ((RTC_IP_AR_RELEASE_MAJOR_VERSION_CFG != RTC_IP_AR_RELEASE_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H) || \
     (RTC_IP_AR_RELEASE_MINOR_VERSION_CFG != RTC_IP_AR_RELEASE_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H) || \
     (RTC_IP_AR_RELEASE_REVISION_VERSION_CFG != RTC_IP_AR_RELEASE_REVISION_VERSION_BOARD_INITPERIPHERALS_PBCFG_H) \
    )
    #error "AutoSar Version Numbers of Rtc_Ip_Cfg.h and Rtc_Ip_BOARD_InitPeripherals_PBcfg.h are different"
#endif
/* Check if this header file and header file are of the same Software version */
#if ((RTC_IP_SW_MAJOR_VERSION_CFG != RTC_IP_SW_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H) || \
     (RTC_IP_SW_MINOR_VERSION_CFG != RTC_IP_SW_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H) || \
     (RTC_IP_SW_PATCH_VERSION_CFG != RTC_IP_SW_PATCH_VERSION_BOARD_INITPERIPHERALS_PBCFG_H) \
    )
    #error "Software Version Numbers of Rtc_Ip_Cfg.h and Rtc_Ip_BOARD_InitPeripherals_PBcfg.h are different"
#endif
/*==================================================================================================
*                                     FILE VERSION CHECKS
==================================================================================================*/
