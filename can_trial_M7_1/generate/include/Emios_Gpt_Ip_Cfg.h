...
*                                     FILE VERSION CHECKS
==================================================================================================*/
#if (EMIOS_GPT_IP_VENDOR_ID_CFG != EMIOS_GPT_IP_VENDOR_ID_BOARD_INITPERIPHERALS_PBCFG_H)
    #error "Emios_Gpt_Ip_Cfg.h and Emios_Gpt_Ip_BOARD_InitPeripherals_PBcfg.h have different vendor ids"
#endif

/* Check if  header file and Emios_Gpt_Ip_BOARD_InitPeripherals_PBcfg.h file are of the same Autosar version */
#if ((EMIOS_GPT_IP_AR_RELEASE_MAJOR_VERSION_CFG != EMIOS_GPT_IP_AR_RELEASE_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H) || \
     (EMIOS_GPT_IP_AR_RELEASE_MINOR_VERSION_CFG != EMIOS_GPT_IP_AR_RELEASE_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H) || \
     (EMIOS_GPT_IP_AR_RELEASE_REVISION_VERSION_CFG != EMIOS_GPT_IP_AR_RELEASE_REVISION_VERSION_BOARD_INITPERIPHERALS_PBCFG_H))
    #error "AutoSar Version Numbers of Emios_Gpt_Ip_Cfg.h and Emios_Gpt_Ip_BOARD_InitPeripherals_PBcfg.h are different"
#endif

/* Check if header file and Emios_Gpt_Ip_BOARD_InitPeripherals_PBcfg.h file are of the same Software version */
#if ((EMIOS_GPT_IP_SW_MAJOR_VERSION_CFG!= EMIOS_GPT_IP_SW_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H) || \
     (EMIOS_GPT_IP_SW_MINOR_VERSION_CFG!= EMIOS_GPT_IP_SW_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_H) || \
     (EMIOS_GPT_IP_SW_PATCH_VERSION_CFG!= EMIOS_GPT_IP_SW_PATCH_VERSION_BOARD_INITPERIPHERALS_PBCFG_H))
    #error "Software Version Numbers of Emios_Gpt_Ip_Cfg.h and Emios_Gpt_Ip_BOARD_InitPeripherals_PBcfg.h are different"
#endif
/*==================================================================================================
*                                          CONSTANTS
==================================================================================================*/
