...
#define PIT_IP_SW_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C             3
...
#endif
#if (PIT_IP_VENDOR_ID_BOARD_INITPERIPHERALS_PBCFG_C != GPT_IRQ_VENDOR_ID)
    #error "Pit_Ip_BOARD_InitPeripherals_PBcfg.c and Gpt_Irq.h have different vendor ids"
#endif
/* Check if this header file and header file are of the same Autosar version */
#if ((PIT_IP_AR_RELEASE_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != GPT_IRQ_AR_RELEASE_MAJOR_VERSION) || \
     (PIT_IP_AR_RELEASE_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != GPT_IRQ_AR_RELEASE_MINOR_VERSION) || \
     (PIT_IP_AR_RELEASE_REVISION_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != GPT_IRQ_AR_RELEASE_REVISION_VERSION) \
    )
    #error "AutoSar Version Numbers of Pit_Ip_BOARD_InitPeripherals_PBcfg.c and Gpt_Irq.h are different"
#endif
/* Check if this header file and header file are of the same Software version */
#if ((PIT_IP_SW_MAJOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != GPT_IRQ_SW_MAJOR_VERSION) || \
     (PIT_IP_SW_MINOR_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != GPT_IRQ_SW_MINOR_VERSION) || \
     (PIT_IP_SW_PATCH_VERSION_BOARD_INITPERIPHERALS_PBCFG_C != GPT_IRQ_SW_PATCH_VERSION) \
    )
    #error "Software Version Numbers of Pit_Ip_BOARD_InitPeripherals_PBcfg.c and Gpt_Irq.h are different"
#endif
/*================================================================================================*/
